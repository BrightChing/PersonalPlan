...
public class FrmLogin extends JDialog implements ActionListener {
	...
	private JButton btnForgetpwd = new JButton("忘记密码");
	...
	public FrmLogin(Frame f, String s, boolean b) {
		...
		this.btnForgetpwd.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btnLogin) {
			...
			dlg.setVisible(true);
		} else if (e.getSource() == this.btnForgetpwd) {
			String userid = this.edtUserId.getText();
			try {
				BeanUser.currentLoginUser = PersonPlanUtil.userManager.load(userid);
				if (BeanUser.currentLoginUser.getPwdquestion() == null) {
					JOptionPane.showMessageDialog(null, "您没有设置密保", "错误", JOptionPane.ERROR_MESSAGE);
					return;
				}
			} catch (BaseException e1) {
				JOptionPane.showMessageDialog(null, e1.getMessage(), "错误", JOptionPane.ERROR_MESSAGE);
			...
			FrmForgetpwd dlg = new FrmForgetpwd(this, "找回密码", true);
			dlg.setVisible(true);
		}
	}
}
